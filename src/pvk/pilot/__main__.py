"""python -m pvk.pilot [vse|p1|p2|p3|p4|report]

vse     stáhne vzorky do raw, změří P1–P4 a vytvoří docs/pilot_report.md + docs/pilot_vyjimky.csv
...
def main(argv: list[str] | None = None) -> int:
    ...
    if prikaz not in {"vse", "p1", "p2", "p3", "p4", "report"}:
